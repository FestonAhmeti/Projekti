function Person(name, lastname) {
  ...
  Kafshe.prototype.Leviz = function () {
    console.log(
      'Kafsha e llojit ' + this.name + ' leviz me shpejtesi ' + this.speed
    );
  };
  Kafshe.prototype.Fluturo = function () {
    throw 'Hakeri osht supernatural po jo deri kit nivel';
  };
  ...
  var Automobili = {
    ...
    get tipi() {
      console.log(
        'Automobili eshte i tipit ' +
          this.lloji +
          ' dhe eshte prodhuar ne vitin ' +
          this.viti
      );
    },
  };
  ...
  var Shkolla = {
    ...
    get nrnxenesvetotal() {
      console.log(
        'Nurmi total i nxenesve ne shkolle eshte ' +
          this.nxenesneklase * this.paralele * this.klasa
      );
    },
  };
  ...
  function Printo(x1, x2) {
    if (x1 * x2 > Number.MAX_VALUE) {
      ...
      console.log('Ky numer eshte i perfshire ne domenin e JS.');
    }
  }
  ...
  function KuptimiEksponentit(x1) {
    ...
    console.log(
      'Numri me perdorimin e metodes toExponential(): ' + x1.toExponential(2)
    );
  }
